...
public class Window implements Runnable {
    ...
    private static final int           NEAR_SWITCH_STATE        = LEFT;                                   // left side
                                                                                                          // of the
                                                                                                          // switch is
                                                                                                          // that of our
                                                                                                          // team
    private static final int           SCALE_STATE              = RIGHT;                                  // right side
                                                                                                          // of the
                                                                                                          // switch is
                                                                                                          // that of our
                                                                                                          // team
    private static final int           FAR_SWITCH_STATE         = RIGHT;                                  // right side
                                                                                                          // of the
                                                                                                          // switch is
                                                                                                          // that of our
                                                                                                          // team
    ...
    private static final float         POWER_CUBE_ZONE_CENTER_Y = SWITCH_CENTER_Y
                    - (SWITCH_HEIGHT + POWER_CUBE_ZONE_HEIGHT) / 2f;
    ...
    private void doSwitches() {
        ...
        GL11.glColor4fv(TEAM_COLOR);
        GL11.glPushMatrix();
        GL11.glTranslatef(FIELD_WIDTH / 2f - SWITCH_PLATE_CENTER_X + (2f * NEAR_SWITCH_STATE * SWITCH_PLATE_CENTER_X),
                        14f, 0f);
        GL11.glBegin(GL11.GL_QUADS);
        ...
        GL11.glColor4fv(TEAM_COLOR);
        GL11.glPushMatrix();
        GL11.glTranslatef(FIELD_WIDTH / 2f - SWITCH_PLATE_CENTER_X + (2f * FAR_SWITCH_STATE * SWITCH_PLATE_CENTER_X),
                        FIELD_HEIGHT - 14f, 0f);
        GL11.glBegin(GL11.GL_QUADS);
        GL11.glVertex2f(-PLATE_WIDTH / 2, -PLATE_HEIGHT / 2);
        GL11.glVertex2f(-PLATE_WIDTH / 2, PLATE_HEIGHT / 2);
    ...
    private void doScale() {
        ...
        GL11.glColor4fv(TEAM_COLOR);
        GL11.glPushMatrix();
        GL11.glTranslatef(FIELD_WIDTH / 2f - SCALE_PLATE_CENTER_X + (2f * SCALE_STATE * SCALE_PLATE_CENTER_X),
                        FIELD_HEIGHT / 2f, 0f);
        GL11.glBegin(GL11.GL_QUADS);
        GL11.glVertex2f(-PLATE_WIDTH / 2, -PLATE_HEIGHT / 2);
        GL11.glVertex2f(-PLATE_WIDTH / 2, PLATE_HEIGHT / 2);
    ...
    private void doPowerCubeZone() {
        ...
        GL11.glColor4fv(OPP_COLOR);
        GL11.glBegin(GL11.GL_QUADS);
        GL11.glVertex2f(-POWER_CUBE_ZONE_WIDTH / 2f,
                        FIELD_HEIGHT - (-POWER_CUBE_ZONE_HEIGHT / 2f + POWER_CUBE_ZONE_CENTER_Y));
        GL11.glVertex2f(-POWER_CUBE_ZONE_WIDTH / 2f,
                        FIELD_HEIGHT - (POWER_CUBE_ZONE_HEIGHT / 2f + POWER_CUBE_ZONE_CENTER_Y));
        GL11.glVertex2f(POWER_CUBE_ZONE_WIDTH / 2f,
                        FIELD_HEIGHT - (POWER_CUBE_ZONE_HEIGHT / 2f + POWER_CUBE_ZONE_CENTER_Y));
