...
public class PathfinderDrive extends CommandBase {
    ...
    private static final int       TICKS_PER_REV    = 1000;
    ...
    protected void initialize() {
        ...
        left.configureEncoder(0, TICKS_PER_REV, DIAMETER);
        right.configureEncoder(0, TICKS_PER_REV, DIAMETER);
    }

    @Override
    protected void execute() {
        l = left.calculate((int) sensors.getEncoderLeft());
        r = right.calculate((int) sensors.getEncoderRight());
        double gyro_heading = sensors.getGyro();
