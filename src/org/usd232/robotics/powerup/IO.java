...
public interface IO extends RobotMap {
	 ...
	 * @version 2018
	 */
	public static final SpeedController leftDriveMotor = IOFactory.motor(LEFT_DRIVE_MOTOR_PORT, LEFT_DRIVE_MOTOR_TYPE);
	/**
	 ...
	 * The solenoid to shift gears
	 */
	// public static final Solenoid gearShiftSolenoid = new
	// Solenoid(SOLENOID_GEAR_SHIFT_PORT);
	/**
	 ...
	 * @version 2018
	 */
	// public static final Solenoid grabSolenoid = new
	// Solenoid(INTAKE_GRAB_SOLENOID);
	/**
	 ...
	 * @version 2018
	 */
	// public static final Solenoid liftSolenoid = new
	// Solenoid(INTAKE_LIFT_SOLENOID);
}
