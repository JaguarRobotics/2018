...
public class Logger {
     ...
     * 
     * @param level
     *            The level of importance of the log message.
     * @param message
     ...
     * @param format
     *            The format of the log statement.
     * @param args
     *            the arguments for the format string that the log came from.
     */
     ...
     *            The throwable being logged.
     * @param format
     *            The format of what is being logged.
     * @param args
     ...
     * 
     * @param message
     *            The message of what is being traced.
     */
     ...
     *            The format of what is being logged.
     * @param args
     *            the arguments for the format string being logged
     */
     ...
     * 
     * @param throwable
     *            The throwable being logged as a trace.
     * @param message
     *            The message being logged with the trace.
     */
     ...
     * 
     * @param throwable
     *            The throwable being logged with a trace.
     * @param format
     *            The format of logging.
     * @param args
     *            the arguments for the format string of whats being logged.
     */
     ...
     *            The format of what is being logged.
     * @param args
     *            the arguments for the format string of the log.
     */
     ...
     * @param message
     *            The message to log with the throwable.
     */
     ...
     *            The throwable to log.
     * @param format
     *            The format to log the throwable.
     * @param args
     *            the arguments for the format string to log with the throwable.
     */
     ...
     * 
     * @param format
     *            The format to log the info.
     * @param args
     *            the arguments for the format string to log the info.
     */
     ...
     *            The throwable to log.
     * @param format
     *            The format to use to log the throwable.
     * @param args
     *            the arguments for the format string to log with the throwable.
     */
     ...
     *            The throwable to log.
     * @param format
     *            The format to log it as.
     * @param args
     *            The class that the message came from.
     */
     ...
     * @param args
     *            the arguments for the format string throwing the error.
     */
     ...
     * 
     * @param format
     *            The format to use to log.
     * @param args
     *            the arguments for the format string that the fatal log came from.
     */
    ...
    /**
     * Logs a formatted throwable with the arguments for the format string that it came from.
     * 
     * @param throwable
     *            The throwable to log.
     * @param format
     ...
     * 
     * @param code
     *            The code that needs to be caught.
     */
